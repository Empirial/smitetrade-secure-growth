...
const CustomerAlerts = () => {
    ...
    const localAlerts = [
        {
            id: 1, type: "warning", title: "Upcoming Loan Repayment",
            message: "Reminder: Your loan repayment of R2,500 to Swift Capital is due in 3 days.",
        ...
        {
            id: 3, type: "info", title: "Delivery Update",
