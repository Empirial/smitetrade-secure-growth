...
const getLinks = (role: string) => {
    const ownerLinks = {
        ...
        Management: [
            ...
            { href: "/owner/stock-adjustment", label: "Stock Adjustments", icon: ClipboardList },
    ...
    const adminLinks = [
        ...
        { href: "/admin/payouts", label: "Store Payouts", icon: Wallet },
        ...
        { href: "/admin/credit-overview", label: "Credit Overview", icon: CreditCard },
